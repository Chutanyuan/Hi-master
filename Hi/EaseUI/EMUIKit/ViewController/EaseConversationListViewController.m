...
//    chatViewController *viewController = [[charViewController alloc] initWithConversationChatter:model.conversation.conversationId conversationType:model.conversation.type];
    
    
    chatViewController * chat = [[chatViewController alloc]init];
    
    
    chat.title = [NSString stringWithFormat:@"与%@会话",model.title];
